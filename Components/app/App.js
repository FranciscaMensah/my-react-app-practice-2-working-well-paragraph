...
export default function App(){
    ...
    const [markdownPreview, setMarkdownPreview] = React.useState(markdown);
    ...
    function handleChange (event){
        ...
        const count = string2.match(htmlTags)
        const stringWithoutTags = string2.replace(htmlTags, '\n\n');
